<div class="blocks index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('name','Block Name'); ?></th>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $block['Block']['id']), array(), __('Are you sure you want to delete # %s?', $block['Block']['name'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
